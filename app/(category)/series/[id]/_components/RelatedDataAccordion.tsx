...
import { useEventsBySeriesIdInfQuery } from '@/queries/events'
...
const RelatedDataAccordion = ({ seriesId }: Props) => {
  const characterQuery = useCharactersBySeriesIdInfQuery({ seriesId })
  const storiesQuery = useStoriesBySeriesIdInfQuery({ seriesId })
  const eventsQuery = useEventsBySeriesIdInfQuery({ seriesId })
  const comicsQuery = useComicsBySeriesIdInfQuery({ seriesId })
